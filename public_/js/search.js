// To adjust parameters, see https://fusejs.io/
...
if(searchQuery){
  ...
  document.getElementById('search-results').innerHTML = "<p class=\"no-results\">… and see what we have got.</p>";
}
...
function executeSearch(searchQuery) {
  ...
  then(function (data) {
    ...
    if (result.length > 0) {
      ...
      document.getElementById('search-results').innerHTML = "<p class=\"no-results\">Sorry, no matches found. Try another term.</p>";
    }
  });
}
