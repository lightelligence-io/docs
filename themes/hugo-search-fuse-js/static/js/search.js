  ...
  result.forEach( function (value, key) {
    ...
    if (tags) {
      ...
      tags.forEach(function (tag){
        ...
        td.setAttribute("class","f6 mb0 link mid-gray mr1 bg-color-dark ph2 pv1 tags mb2 search_tags");
        td.appendChild(node);
        tr.appendChild(td);
      });
    ...
    if (categories) {
      ...
      categories.forEach(function (category){
        ...
        td.setAttribute("class","f6 mb0 link mr1 bg-light-blue ph2 pv1 tags mb2 search_tags--blue");
        td.appendChild(node);
        tr.appendChild(td);
      });
